        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "varchar(60)", unicode: false, maxLength: 60, nullable: true),
                    ...
                    ThemePreference = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "System"),
                    LanguagePreference = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false, defaultValue: "tr"),
                    ...
                    PendingOtpCodeHash = table.Column<string>(type: "varchar(44)", unicode: false, maxLength: 44, nullable: true),
                    ...
                    IsOnboardingCompleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ...
                    OriginalEmailHash = table.Column<string>(type: "varchar(44)", unicode: false, maxLength: 44, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_LanguagePreference", "LanguagePreference IN ('tr','de')");
                    ...
                    table.CheckConstraint("CK_Users_ThemePreference", "ThemePreference IN ('Light','Dark','System')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QrTokenHash = table.Column<string>(type: "varchar(44)", unicode: false, maxLength: 44, nullable: false),
                    PairingCode = table.Column<string>(type: "char(4)", unicode: false, fixedLength: true, maxLength: 4, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    RequesterIp = table.Column<string>(type: "varchar(45)", unicode: false, maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenHash = table.Column<string>(type: "varchar(44)", unicode: false, maxLength: 44, nullable: false),
